...
func (l *Logger) Debug(msg string, fs ...logger.Field) {
	l.logger.Debug(msg, fs...)
}

// Info 輸出 Info 等級的日誌訊息
func (l *Logger) Info(msg string, fs ...logger.Field) {
	l.logger.Info(msg, fs...)
}

// Warn 輸出 Warn 等級的日誌訊息
func (l *Logger) Warn(msg string, fs ...logger.Field) {
	l.logger.Warn(msg, fs...)
}

// Error 輸出 Error 等級的日誌訊息
func (l *Logger) Error(msg string, fs ...logger.Field) {
	l.logger.Error(msg, fs...)
}

// With 返回一個新的 Logger 實例，預先附加指定的結構化欄位
func (l *Logger) With(fs ...logger.Field) logger.Logger {
	return &Logger{
		core:   l.core,
